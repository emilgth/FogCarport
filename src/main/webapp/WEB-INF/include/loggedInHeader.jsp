        ...
        <div class="nav navbar-nav">
            ...
            <form class="form-inline">
                <form name="customerPage" action="FrontController" method="POST">
                    ...
                    <button class="btn btn-primary" type="submit" value="Se mine ordrer ordrer">Min side</button>
                    <button class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm">Log ud
                    </button>
                </form>
                <!-- Small modal -->
